...
router.post('/broadcast/start', optionalAuth, (req, res, next) => channelController.startBroadcast(req, res, next));
router.post('/broadcast/stop/:id?', optionalAuth, (req, res, next) => channelController.stopBroadcast(req, res, next));
